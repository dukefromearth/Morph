...
function currentServerTime() {
    return firstServerTimestamp + (Date.now() - gameStart) - average_time_between_server_updates;//(max / average_time_between_server_updates) * average_time_between_server_updates;
}
